...
describe('BoardEffectsHandler', () => {
  ...
  beforeEach(() => {
    ...
    boardEffectsHandler = new BoardEffectsHandler(stateManager, mockProcessTranscript)
  })
  ...
  describe('checkAndApplySquareEffects()', () => {
    ...
    it('should do nothing for non-position paths', async () => {
      stateManager.set('board.squares', { '5': { type: 'encounter', name: 'Bear' } })
    ...
    it('should trigger processTranscript callback for square with effects', async () => {
      const squareData = { type: 'encounter', name: 'Bear', difficulty: 'hard' }
    ...
    it('should pass correct context depth (depth + 1)', async () => {
      ...
      await boardEffectsHandler.checkAndApplySquareEffects('players.p1.position', { depth: 2, maxDepth: 5 })
    ...
    it('should skip processing when approaching max depth', async () => {
      ...
      await boardEffectsHandler.checkAndApplySquareEffects('players.p1.position', { depth: 4, maxDepth: 5 })
  ...
  describe('isProcessingEffect()', () => {
    ...
    it('should return true during effect processing', async () => {
      ...
      await boardEffectsHandler.checkAndApplySquareEffects('players.p1.position', { depth: 0, maxDepth: 5 })
